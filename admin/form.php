...
<body>
  ...
  <div class="container">
    <form method="post" id="editForm" action="index.php?action=<?=$_GET['action']?>&id=<?=$_GET['id']?>"></form>
    <textarea class="form-control" rows="5" form="editForm" name="textedit"><?=$formtext?></textarea>
